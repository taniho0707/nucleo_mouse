...
//タイヤ円周(mm)
#define TIRE_ROUND 69.08

//タイヤ1周分のエンコーダパルス数
#define TIRE_ROUND_PULSE 8750

//エンコーダ1パルスあたりの距離(m)
#define DISTANCE_PULSE 0.00789485714285714
...
//ジャイロの感度(要詳細)
//#define SENSITIV_GYRO_R 0.03175
//#define SENSITIV_GYRO_L 0.0317
#define SENSITIV_GYRO_R 0.03145
#define SENSITIV_GYRO_L 0.03145
#define ZERO_GYRO 33.01144
